...
using DavidSpeck.CSharpDocOutline;

namespace CSharpDocOutline_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        {
            IVsPackage package = new CSharpDocOutlinePackage() as IVsPackage;
            ...
            MethodInfo method = typeof(CSharpDocOutlinePackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
